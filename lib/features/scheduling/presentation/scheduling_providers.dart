...
import '../data/cover_request_repository.dart';
...
final schedulingConfigRepositoryProvider = Provider<SchedulingConfigRepository>(
  (ref) {
...
final availabilityFocusedMonthProvider = StateProvider<DateTime>((ref) {
...
final shiftsForMonthProvider = StreamProvider.family<List<ShiftModel>, String>((
  ref,
  location,
) {
...
final userShiftsProvider = StreamProvider.family<List<ShiftModel>, String>((
  ref,
  userId,
) {
  final date = ref.watch(selectedDateProvider);
...
final coverRequestRepositoryProvider = Provider<CoverRequestRepository>((ref) {
  return CoverRequestRepository(
    authRepository: ref.watch(authRepositoryProvider),
  );
});

final pendingCoverRequestsProvider = StreamProvider<List<CoverRequestModel>>((
  ref,
) {
  return ref.watch(coverRequestRepositoryProvider).watchPending();
});
...
final employeeStatsProvider =
    Provider.family<AsyncValue<EmployeeStats>, String>((ref, userId) {
